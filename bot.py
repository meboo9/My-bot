...
# ================== إعدادات البوت ==================
TOKEN = os.environ.get("TOKEN", "8393532186:AAHZbpgZ0OVrBBmJb4pjRzdNc1CiD6IXPiQ")  
# إذا لم يكن هناك متغير بيئة، يستخدم التوكن الافتراضي الجديد
OWNER_ID = 123456789
...
# ================== تشغيل البوت ==================
bot.polling(non_stop=True)    bot.reply_to(message, f"🆔 ID حسابك هو: {message.from_user.id}", parse_mode="Markdown")
